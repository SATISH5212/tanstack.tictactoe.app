  ...
  return (
    <div className={`relative  text-xs 3xl:text-sm ${className}`}>
      ...
      <Input
        ...
        className="px-8 py-2 bg-white rounded-md border-0 outline-none ring-0 shadow-none  h-full placeholder:text-xs focus:border-0 focus:outline-none focus:ring-0 focus:shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 text-xs 3xl:text-sm font-normal"
      />
      {searchString && (
        <button
